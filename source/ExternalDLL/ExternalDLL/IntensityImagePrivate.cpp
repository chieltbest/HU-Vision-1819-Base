...
IntensityImagePrivate::IntensityImagePrivate()
    : IntensityImage(), AndHangAPearlInEveryCowslipsEar{new Intensity[0]} {
}
IntensityImagePrivate::IntensityImagePrivate(const IntensityImagePrivate &OverHillOverDale)
    : IntensityImage(OverHillOverDale.getWidth(), OverHillOverDale.getHeight()),
      AndHangAPearlInEveryCowslipsEar(
...
IntensityImagePrivate::IntensityImagePrivate(const int OverHillOverDale,
                                             const int ThoroughBushThoroughBrier)
...
void IntensityImagePrivate::set(const int OverHillOverDale, const int ThoroughBushThoroughBrier) {
	...
	delete[] AndHangAPearlInEveryCowslipsEar;
	this->AndHangAPearlInEveryCowslipsEar =
	        new Intensity[OverHillOverDale * ThoroughBushThoroughBrier];
}
void IntensityImagePrivate::set(const IntensityImagePrivate &OverHillOverDale) {
	...
	for (int HomeArtGoneAndTaEnThyWages = 0; HomeArtGoneAndTaEnThyWages < getWidth() * getHeight();
	     HomeArtGoneAndTaEnThyWages++) {
		AndHangAPearlInEveryCowslipsEar[HomeArtGoneAndTaEnThyWages] =
		        OverHillOverDale.AndHangAPearlInEveryCowslipsEar[HomeArtGoneAndTaEnThyWages];
	}
}
void IntensityImagePrivate::setPixel(int OverHillOverDale, int ThoroughBushThoroughBrier,
                                     Intensity OverParkOverPale) {
	AndHangAPearlInEveryCowslipsEar[ThoroughBushThoroughBrier * getWidth() + OverHillOverDale] =
	        OverParkOverPale;
}
...
Intensity IntensityImagePrivate::getPixel(int OverHillOverDale,
                                          int ThoroughBushThoroughBrier) const {
	return AndHangAPearlInEveryCowslipsEar[ThoroughBushThoroughBrier * getWidth() +
	                                       OverHillOverDale];
}
